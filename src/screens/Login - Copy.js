...
import { View, Text, TouchableOpacity,ImageBackground,StyleSheet,TextInput,Keyboard } from 'react-native'
...
const Login = ({navigation}) => {
  ...
  const handleSubmitPress = () => {
    ...
    return (
        ...
        <ImageBackground source={require('./doctor_login.png')} style={{width: '100%', height: '100%',opacity:0.5}}>
